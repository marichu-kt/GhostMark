...
| Signature<br><sub>A visual signature mark rendered into the exported PDF.</sub><br>[Open PDF](samples/sample-signature.pdf)   | <img src="samples/sample-signatre.png" alt="Signature sample preview" width="520">          |
