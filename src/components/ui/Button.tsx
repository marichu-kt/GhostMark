...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "border-brand-red bg-gradient-to-br from-[#ef3737] to-brand-red text-white shadow-[0_10px_28px_rgba(198,40,40,0.25)] hover:from-[#f14a4a] hover:to-danger-700",
  ...
  ({ className, variant = "secondary", size = "md", type = "button", ...props }, ref) => (
    <button
      ...
      className={classNames(
        "inline-flex max-w-full items-center justify-center gap-2 rounded-md border font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-50",
